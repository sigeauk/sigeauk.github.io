...
* **Quality Score (50 pts):** TIDE parses the rule query—supporting KQL, EQL, and ES|QL—and uses Regex to extract every referenced field name. It then queries the specific Elasticsearch index mappings to verify those fields actually exist and checks their data types.
